...
router.route('/mongo/putParents')
	//gets all users
	.get(function(req, res){
		execController.insertRandomParents(req, res);
	});

router.route('/mongo/putSitters')
	//gets all users
	.get(function(req, res){
		execController.insertRandomSitters(req, res);
	});

router.route('/mongo/removeParents')
	//gets all users
	.get(function(req, res){
		execController.removeParents(req, res);
	});

router.route('/mongo/removeSitters')
	//gets all users
	.get(function(req, res){
		execController.removeSitters(req, res);
	});
